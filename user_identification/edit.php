...
if (isset($_POST['update_account'])) {
    ...
    $query = "UPDATE `registration` SET `firstname` = '$firstname', `username` = '$username', `lastname` = '$lastname', `email` = '$email', `dob` = '$dob', `hobby` = '$hobby_temp', `gender` = '$gender', `country` = '$country', `message` = '$message', `profile_image` = '$file' WHERE `registration`.`id` = $user_id";
